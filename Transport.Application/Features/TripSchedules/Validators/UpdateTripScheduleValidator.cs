...
{
    public class UpdateTripScheduleValidator : AbstractValidator<UpdateTripScheduleCommand>
    {
        public UpdateTripScheduleValidator()
        {
        ...
        private static bool HasAnyActiveDay(UpdateTripScheduleCommand command)
        {

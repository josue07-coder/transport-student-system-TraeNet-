        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Sectors_SchoolDistricts_SchoolDistrictId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RouteAssignments_Drivers_DriverId",
                        column: x => x.DriverId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Guardians_Sectors_SectorId",
                        column: x => x.SectorId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Schools_Sectors_SectorId",
                        column: x => x.SectorId,
                        principalTable: "Sectors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Stops_Sectors_SectorId",
                        column: x => x.SectorId,
                        principalTable: "Sectors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Trips_RouteAssignments_RouteAssignmentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentRouteAssignments", x => new { x.StudentId, x.RouteAssignmentId });
                    table.ForeignKey(
                        name: "FK_StudentRouteAssignments_RouteAssignments_RouteAssignmentId",
                        column: x => x.RouteAssignmentId,
                        principalTable: "RouteAssignments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Guardians_DocumentNumber",
                table: "Guardians",
                column: "DocumentNumber",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Guardians_SectorId",
                table: "Guardians",
                column: "SectorId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SchoolDistricts_Code",
                table: "SchoolDistricts",
                column: "Code",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Schools_SectorId",
                table: "Schools",
                column: "SectorId");

            migrationBuilder.CreateIndex(
                name: "IX_Sectors_Name_City",
                table: "Sectors",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentRouteAssignments_RouteAssignmentId",
